...
export default function LeadMyActivitiesPage() {
    ...
    return (
        <div className="space-y-12">
            <div>
                ...
                <p className="text-muted-foreground">Select a session to start reporting issues as a Tester.</p>
            </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {activeSessions.map((session) => (
                            <Card key={session._id} className="flex flex-col border-2 hover:border-primary/20 transition-all">
                                ...
                                <CardFooter>
                                    <Link href={`/lead/my-activities/${session._id}`} className="w-full">
                                        <Button className="w-full" variant="default">Join Testing</Button>
                                    </Link>
                                </CardFooter>
                            </Card>
                        ))}
